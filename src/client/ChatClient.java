...
public class ChatClient {
        ...
        try {
            ...
            if (prompt != null && prompt.equals("ENTER_USERNAME")) {
                ...
                if (response != null && response.startsWith("SUCCESS")) {
                    ...
                    System.out.println("╚════════════════════════════════════════════╝");
                    System.out.println(response.substring(9)); // Remove "SUCCESS: "
                    ...
                    System.err.println("Server rejected connection: " + 
            ...
            System.err.println("Unexpected server response. Connection failed.");
            disconnect();
            return false;
            ...
            System.err.println("╚════════════════════════════════════════════╝");
            System.err.println("Could not connect to server at " + serverAddress + 
                ":" + serverPort);
            System.err.println("\nPossible reasons:");
    ...
    public void handleServerDisconnection() {
        if (connected) {
            ...
            System.err.println("Please restart the client to reconnect.\n");
    ...
    public void start() {
        ...
        try {
            ...
            System.out.println("╔════════════════════════════════════════════╗");
            System.out.println("║         LAN CHAT CLIENT v1.0               ║");
            System.out.println("╚════════════════════════════════════════════╝\n");
            ...
            if (address.isEmpty()) {
                System.err.println("ERROR: Server address cannot be empty");
                return;
            }
